    ...
    return html`
      ...
      <section class="menu-container" role="dialog" aria-hidden="${this.isMenuOpen ? 'false' : 'true'}">
        ...
        <ul class="${classMap({ active: this.isMenuOpen })}" @transitionend="${() => this.firstElem.focus()}">
          ...
          <li class="menu-item">
            <a href="http://localhost:5000/home" target="_self" data-track="menuHomeBtn">Home</a>
          </li>
          <li class="menu-item">
            <a href="http://localhost:5000/orders" target="_self" data-track="menuOrdersBtn">My Orders</a>
          </li>
          <li class="menu-item">
            <a href="http://localhost:5000/help" id="menuFAQ">Get Help</a>
          </li>
          <li class="menu-item">
            <a href="http://localhost:5000/login/" id="signInMenu" @keydown="${this.sendToTop}">${this.loggedIn ? 'Sign Out' : 'Sign In'}</a>
